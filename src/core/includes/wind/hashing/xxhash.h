...
#pragma once
#define WIND_HASHING_SEED 0xE49781BB2B0FEEF9
...
public:
  ...
  explicit XXHash64(uint64_t seed=WIND_HASHING_SEED)
  {
  ...
  /** @param  input  pointer to a continuous block of data
      ...
      @return 64 bit XXHash **/
  static uint64_t hash(const void* input, uint64_t length, uint64_t seed=WIND_HASHING_SEED)
  {
